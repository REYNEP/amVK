...
/** amVK_Memory is in WIP stage.... \todo it shouldn't be here */
...
class amVK_DeviceMK2 {
    ...
    VkDevice D = nullptr;
    VkPhysicalDevice PD;
    uint32_t PD_index = 0;      /** index into HEART->PD... [we had space for this...] */
     ...
     * \param    MAX-exts: 200
     * \param    MAX-qCIs: 100
     * \param  PD: use nullptr to automatically choose the best one....  also check amVK_SurfaceMK2::select_DisplayDevice()
     * 
     * \note \see amVK_SurfaceMK2::select_DisplayDevice()
     */
